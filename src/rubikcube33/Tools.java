...
public class Tools {
     ...
     *
     * The random source can be set by {@link rubikcube33.Tools#setRandomSource(java.util.Random)}
     *
     ...
     *
     * @see rubikcube33.Tools#setRandomSource(java.util.Random)
     * @see rubikcube33.Search#solution(java.lang.String facelets, int maxDepth, long timeOut, long timeMin, int verbose)
     */
     ...
     *
     * @param facelets is the cube definition string , see {@link rubikcube33.Search#solution(java.lang.String facelets, int maxDepth, long timeOut, long timeMin, int verbose)}
